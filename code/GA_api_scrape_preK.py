...
#%%
# Define the parameters seen in the network request (programType = P shown in the PreK network request)
base_params = {
    'providerNumber': '',
    'name': '',
    'zipCode': '',
                ...
                try:
                    ...
                    if isinstance(data, list):
                        ...
                        if idx % 50 == 0 or idx in progress_intervals:
                            ...
                            progress_file = f'GA_child_care_providers_preK_progress_{idx}_of_{total_zip_codes}_{date}.json'
...
if __name__ == "__main__":
    ...
    save_data(all_records, "GA_child_care_providers_preK_complete")
